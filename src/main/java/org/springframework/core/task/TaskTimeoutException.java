...
/**
 * 当异步任务执行器({@link AsyncTaskExecutor})因超过给定的任务超时时间而拒绝接受执行它时，抛出该异常。<br>
 * 继承自 {@link TaskRejectedException}
 * 
 * <p>Exception thrown when a {@link AsyncTaskExecutor} rejects to accept
